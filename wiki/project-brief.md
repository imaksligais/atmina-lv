...
- **Video** — debašu un interviju transkripti (AiLab ASR + pyannote diarizācija); operatīvs kopš 2026-07-22
...
## Aģentu sistēma (11 specializēti aģenti)
...
- `@brief-writer` — dienas neitrālie kopsavilkumi
...
- `@video-extractor` — pozīciju ekstrakcija no video transkriptiem ar laika enkuriem (operatīvs kopš 2026-07-22)
- `@weekly-brief-writer` — nedēļas pārskats (starpdienu sintēze)
- `@outlet-researcher` — mediju caurskatāmības fakti pēc pieprasījuma
...
- pietiek.com bloķē Cloudflare — nav iekļauts (sk. `BACKLOG.md` § Avoti, `[BLOKĒTS] pietiek.com`)
