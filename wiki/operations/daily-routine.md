...
Dienas rutīnai kanoniskais ceļš ir ŠAURAIS renders + pilna koka deploy (kopš 2026-09-16 Cloudflare; šaurais renders neizmet citu domēnu lapas no koka) (sk. `/dienas-rutina` prasmi un [[commands]] § Narrow render):
...
**NB:** `finanses.html` ir manuāli kurēta lapa (avots ir ĀRPUS šī repo: `OppTracker/Deklare2/finanses_content.html` — mantots operatora ceļš, nemeklē to atmina kokā) — `generate_public_site()` to neaiztiek.
