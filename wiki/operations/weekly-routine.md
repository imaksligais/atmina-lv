...
Nedēļas pārskatam papildus dienas pārbaudēm: frakciju sadalījums katram citētajam `vote_id` jāņem no `saeima_votes.summary`, ne no pārstāstījuma (CLAUDE.md T6 „party ≠ faction"), un balsojumu ķēde pa `document_nr` jāizlasa pilnībā (T14).
