...
> **Divi vārti kanoniskajā promptā (2026-09-02):** Step 2.0 pirms skrāpēšanas uzskaita visus attiecīgās dienas sēžu UUID (vienai dienai to mēdz būt vairāki — 2026-07-23 trīs, 2026-08-20 divi), un Step 5.bis pēc ielādes ar `scripts/audit_saeima_agenda_parity.py --dates YYYY-MM-DD` pārbauda darba kārtības pilnīgumu par visu datumu, ne par vienu sēdi.
