...
| [@video-extractor](video-extractor.md) | Pozīciju ekstrakcija no video debašu transkriptiem | Pēc `.venv/Scripts/python.exe -m src.video_ingest finalize <slug>` (ceļš pārbaudīts ar vienu E2E testu 2026-07-22, produkcijā nekad nav izmantots — 0 `platform='video'` dokumentu; sk. CLAUDE.md Data Contract #13) |
...
- **Circuit breaker** — katram aģentam ir savi limiti (claim-extractor: 12 docs/politiķis/sesijā (samazināts no 33 uz 2026-04-22 pēc batch-drift diagnostikas); contradiction-hunter: 5 politiķi sesijā). Nepārkāpt. Par >5 docs vienam politiķim — dispečē paralēlus sub-aģentus **pa politiķiem** (viens politiķis = viens aģents; viena politiķa dokumentus starp aģentiem nedala — dublikātu risks, sk. `backlog/agenti-pipeline.md` 2026-08-25).
