...
| [@video-extractor](video-extractor.md) | Pozīciju ekstrakcija no video debašu transkriptiem | Pēc `.venv/Scripts/python.exe -m src.video_ingest finalize <slug>` (pipeline darbspējīgs kopš 2026-07-22, E2E verificēts) |
