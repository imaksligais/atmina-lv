...
def render_pretruna_og_card(contradiction_id: int, out_path: Path) -> Path:
    ...
    The public site rendering pipeline (`src.render.contradictions._render_og_cards`)
...
# Party colors mirror src.render._common.PARTY_COLORS — kept decoupled to avoid
