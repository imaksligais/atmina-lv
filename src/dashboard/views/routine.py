...
_STATUS_ICONS = {
    "done": "✓",
    # 'n/a' — the step had nothing to do. Complete, but not the same claim as
    # 'done', and it must not render as ✓: on a day the ingest fails, every
    # downstream step has nothing to do (src/routine.py::check_routine).
    "n/a": "○",
    "partial": "◐",
    "missing": "✗",
    "stale": "◐",
