...
_MOTIF_TOPIC_MAP: list[tuple[re.Pattern, str]] = [
    ...
    # --- Subject-before-committee (2026-09-15, 09-10 load): a referral motif
    #     carries the committee's name ("nodošanu Izglītības, kultūras un
    #     zinātnes komisijai. Par vēstures prioritāru mācīšanu"), and the
    #     generic `kultūr` stem below won on the committee, not the bill —
    #     vote 8149 landed in Kultūra, its sibling 8148 (same bill, no
    #     committee named) in the Valsts pārvalde fallback. These subject
    #     stems therefore sit ABOVE the Kultūra block. The systemic fix
    #     (strip the referral clause before matching) would re-derive 26 of
    #     952 historic committee votes — a migration decision, see
    #     backlog/saeima.md. ---
    (_stem("mācīšan"), "Izglītība"),                             # vēstures prioritāra mācīšana (1104/Lm14)
    (_stem("pacientu tiesīb"), "Veselības aprūpe"),               # Pacientu tiesību likums (1513/Lp14)
    (_stem("medicīnisk"), "Veselības aprūpe"),                    # medicīniskās palīdzības pieejamība (136/P14)
    ...
    # --- "elektr*" specific guards (2026-07-28) — MUST precede the Energy
    #     block. Bare _stem("elektr") mis-routed media / communications /
    #     e-money / e-cigarette / e-government bills to Degviela un
    #     enerģētika ("Elektronisko plašsaziņas līdzekļu likums" → 3473
    #     claims; BACKLOG § topic_map "elektr"). Same substring class the
    #     Sports comment in src/topic_map.py warns about. ---
    (_stem("plašsaziņ"), "Sabiedriskie mediji"),
    (_stem("elektronisko sakaru"), "Digitālā politika"),
    (_stem("elektronisko dokument"), "Digitālā politika"),
    (_stem("elektroniskās adreses"), "Digitālā politika"),
    (_stem("elektroniskā vidē"), "Digitālā politika"),
    (_stem("elektroniskās naudas"), "Budžets un finanses"),
    (_stem("tabakas"), "Veselības aprūpe"),
    (_stem("smēķēšan"), "Veselības aprūpe"),
    (_stem("elektrovilcien"), "Transports"),
    (_stem("elektroskrejriteņ"), "Transports"),

    # --- Energy (2026-07-28: bare "elektr" narrowed to energy-specific
    #     stems — see the guard block above) ---
    (_stem("enerģēt"), "Degviela un enerģētika"),
    (_stem("degviel"), "Degviela un enerģētika"),
    (_stem("elektroenerģij"), "Degviela un enerģētika"),
    (_stem("elektroapgād"), "Degviela un enerģētika"),
    (_stem("elektrostacij"), "Degviela un enerģētika"),
    (_stem("elektrotīkl"), "Degviela un enerģētika"),
    (_stem("elektrolīnij"), "Degviela un enerģētika"),
    (_stem("elektrības"), "Degviela un enerģētika"),
