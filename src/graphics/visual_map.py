"""
Visual metaphor mapping for the 33 canonical political topics.
...
VISUAL_MAP: dict[str, dict[str, str]] = {
    ...
    "NVO un pilsoniskā sabiedrība": {
        "metaphor": "many small hands raising a shared canvas roof, grassroots circle of chairs",
        "mood": "communal, quietly determined",
        "accent": "earthy umber",
    },
    "Lauksaimniecība": {
