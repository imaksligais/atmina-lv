...
### [SLĒGTS 2026-09-22] Partiju tests — 12 apgalvojumi × 14 sarakstu programmas, publicēts ar avotiem; interaktīvais tests atcelts

**PUBLICĒTS** `https://atmina.lv/analizes/partiju-tests.html` — 2026-09-20 22:20 (deploy `654d8871`), pārpublicēts pēc D1b rubrikas audita 2026-09-22 (deploy `0badcb2d`; dzīvā lapa 200, baitu identiska build). **Gala skaitļi:** cvk 60 / pilnā 4 / izteikums 5 / klusē 99; bilance 55:14; nolasāmas 69 no 168; quiz vārts 1/12. **D1b (09-22, SLĒGTS):** 7 rubrikas zari balstījās uz atslēgvārdu, ne apgalvojumu → 15 šūnas uz „neizsakās”, 3 aprauti citāti paplašināti, visas 12 rubrikas pārrakstītas; mācība CLAUDE.md T16. **Interaktīvais tests atcelts** (operators 09-22): lapa saka „pagaidām nav plānots”, vārta skaitlis paliek redzams — vārts nesasniedzams pēc dizaina (programmas sola, neiebilst), nākamajam testam vajag „A vai B” jautājumus. **Atvērts:** q01 rinda (SC/LPV/ASL paliek `par`) un `claim_id` ≠ citāta avots — abi handoff § 7. Ieejas punkts `docs/plans/2026-09-17-partiju-tests-handoff.md`; v2 idejas `2026-09-20-partiju-tests-v2-briefi.md` § D2–D4; vēsture `2026-09-10-skirotava-atmina.md` + CHANGELOG 09-14 (4), 09-20 (19), 09-22 (1).
...
- **Gala revīzijas minoru paliekas:** pretrunu fakta datums = `new_date` nevis `detected_at`. (Līderu joslas saite → «Visi profili →» un `initials` no `rankings.py` — izpildīts 2026-09-23, CHANGELOG 2026-09-23 (4).)
- **Atrasts 2026-09-23 (C aģents, nav labots — ārpus sākumlapas):** `analizes.html` 360 px platumā ritinās horizontāli par 15 px (`scrollWidth` 375); tas pats ar nemainītu HEAD CSS, tātad vecs defekts. Vainīgais — `.pagehead-tabs` josla / kāds `main` bērns; sākumlapā šāda nav.
