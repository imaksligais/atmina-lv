...
def main(argv=None) -> int:
    ...
    # Katrs saglabātais dokuments tiek embedots (embed_document -> document_vectors),
    # tāpēc salauzts embedding steks nozīmē daļēju rakstīšanu, ne tīru kļūmi.
    # Vārti sit pirms pirmās rindas un nosauc pareizo interpretatoru.
    if not args.dry_run:
