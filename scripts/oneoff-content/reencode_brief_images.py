...
Usage::
    ...
    .venv/Scripts/python scripts/oneoff-content/reencode_brief_images.py          # incremental
    .venv/Scripts/python scripts/oneoff-content/reencode_brief_images.py --force  # rebuild all
"""
