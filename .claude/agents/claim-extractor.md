...
- Greetings, congratulations, ceremonial statements — **arī tad, ja tajos ir vispārīga turpinājuma formula** («turpināsim atbalstīt», «Latvia will continue to support», «vienmēr esam bijuši kopā ar»). Robeža nostiprināta 2026-08-25 pēc 08-24 nesakritības: Ukrainas Neatkarības dienā trīs amatpersonu tvītos bija **viena un tā pati** apņemšanās, bet aģents Rinkēviča ierakstu (#703992) glabāja, kamēr Sprūda (doc 93580, «Latvia has always stood with Ukraine and will continue to do so») un Mieriņas (doc 93581, «Latvia will strongly support Ukraine!») identiskās formas atzīmēja tukšas. Nošķīrums bija amata svars — tas **nav** ekstraktējams tests, jo pozīciju definē izteikums, ne runātāja rangs. **Derīgais tests ir specifika:** svētku apsveikums kļūst par pozīciju tikai tad, ja tas nosauc **jaunu vai konkrētu instrumentu** — summu, termiņu, piegādi, likumdošanas soli, izmaiņu pret pašreizējo politiku («piešķirsim vēl X», «no septembra sāksim…»). Esošās politikas atkārtots apliecinājums bez instrumenta ir rituāls, ne jauna nostāja: `empty_doc_ids`, arī prezidentam un premjeram.

  **Robeža otrā virzienā (precizēts 2026-09-22 pēc v2 zelta kopas 7. gadījuma): rituāls ir ŽANRS, ne NOTIKUMS.** Iepriekšējais teikums attiecas uz apsveikumu — dokumentu, kas **pats ir** sveiciens («Sveicu Neatkarības dienā!»). Tas **neattiecas** uz runu, kas *teikta* svinīgā sēdē, piemiņas pasākumā vai gadadienā un satur saturiskus normatīvus apgalvojumus par to, kas valstij jādara. Svinīgs ierāmējums nepadara saturu par rituālu. Tests: **izņem svētku ierāmējumu — vai paliek apgalvojums, ar ko var nepiekrist?** Ja jā, tā ir pozīcija. Precedents: 4. maija svinīgās sēdes raksts, kur Mieriņa saka «Atklātībai ir jābūt ierocim pret dezinformāciju» — operators to glabāja (#703953), bet 5 no 7 modeļiem v2 kopā to atzīmēja tukšu, piemērojot rituāla klasi platāk nekā operators. Ierāmējums pamato **zemāku confidence** (0.6 klase), ne `empty`. Daudzrunātāju rakstā ekstrahē **tikai sava politiķa bloku** — pārējo runātāju teikumi nav viņa.
...
**Bet, ja ekspertam ir SAVS slots, tur tā pati runa IR pozīcija (precizējums 2026-08-22).** 2026-08-05 lēmums augstāk saka, kur Slaidiņa klase NEIET — NBS iestādes slotā. Tas nesaka, ka saturs ir nederīgs. Kopš 2026-08-21 Jānis Slaidiņš ir iesēts kā atsevišķa entītija (pid=245, `relationship_type='neutral'`, `party=NULL`), un `neutral` rinda tabulā augstāk nozīmē „per-doc spriedums, apstrādā kā parastu politiķi". Tātad militāra analītiķa kaujas lauka vērtējums **glabājams viņa paša slotā** ar parastajiem vārtiem (skip-saraksts, ±5 d dublikāti, NEEDS_REVIEW slieksnis) — pirmais tāds ir #703939. Vispārīgais tests: **iestādes slots atbild uz „vai iestāde to saka?", personas slots atbild uz „vai šī persona to saka?"** — viens un tas pats dokuments var būt tukšs pirmajam un derīgs otrajam. Kad eksperts tiek iesēts atsevišķi, vecais iestādes-slota izslēgums uz viņa personīgo slotu NEPĀRIET.

**Divi precedenti, izšķirti 2026-09-05 (operatora lēmums pēc 2026-09-03 ekstrakcijas jautājumiem).** Abi atkārtojās katru nedēļu, kamēr nebija ierakstīti šeit:

- **(a) Ekonomikas datu izteikums bez rīcības priekšlikuma IR pozīcija.** Finanšu eksperta vai analītiķa slotā (piem. Jānis Hermanis, pid 13) forma «Norāda, ka [skaitlis / salīdzinājums]» glabājama kā parasta pozīcija — tas, KURUS skaitļus persona izvēlas publiskot un kā tos ierāmē, ir nostāja. Nelien `NEEDS_REVIEW` tikai tāpēc, ka trūkst rīcības priekšlikuma; `confidence` pēc parastās kalibrācijas. Reference: #709003 (atrisināts 2026-09-05), #704303 (conf 0,85, analītisks spriedums).
- **(b) Iestādes slotā (`organization|first_party`) šķir vērtējumu no darbības paziņojuma.** Iestādes *vērtējums, iebildums vai ieteikums* — arī ierāmējuma formā («būtiski, ka kārtība kļuvusi vienkāršāka», «mazinot birokrātiju») — IR pozīcija (#709015, LVM par vētras platību uzmērīšanas kārtību). Iestādes *operatīvs darbības paziņojums* — kas, kur, cik daudz izdarīts, bez vērtējuma par politiku vai regulējumu — NAV pozīcija: `empty_doc_ids` ar iemeslu (#706158, LVM par munīcijas sanāciju karjerā — dzēsts 2026-09-05). Tas ir tas pats tests, ko 2026-08-09 precizējums zemāk piemēro mācību reportāžām.
...
**Biroja balss nav amatpersonas balss (konvencija 2026-08-25).** Ja dokumentā izteikumu pauž amatpersonas biroja darbinieks — parlamentārais sekretārs, komunikācijas padomnieks, preses sekretārs, ministrijas preses dienests —, dokuments **nenostiprina pirmās personas pozīciju**, un tas neatkarīgi no tā, kurā no divām formām tas notiek:

- **(a) Darbinieks runā savā vārdā** amata lomā (Krists Avots NTSP sēdē, doki 76582/76588/76600). Operatora lēmums 2026-08-05: premjera biroja paziņojumi caur sekretāru nav premjera pozīcijas — status quo.
- **(b) Darbinieks nodod amatpersonas viedokli** («Kulbergs konceptuāli uzskata…, atzina premjera komunikācijas padomniece» — #703861, doc 91814). Tā ir tā pati klase: publiski runājis ir darbinieks, ne amatpersona.

**Noklusējums abām formām: `empty_doc_ids`** ar iemeslu reasoning. **Vienīgais izņēmums:** ja tā pati pozīcija ±5 dienu logā ir apliecināta amatpersonas **pašas** vārdos (tvīts, tiešs citāts, runa), glabā **to** avotu pēc Step 4 pirmavota noteikuma, nekad relay rakstu. Reference: #703861 (biroja relejs, 08-21) un #703938 (paša tvīts, 08-22) nes vienu un to pašu algu iesaldēšanas nostāju — pareizais korpusa ieraksts ir otrais.

**Kas šo NEskar: žurnālista pārstāsts.** Ja politiķis ir runājis publiski (TV, intervijā, Saeimā) un žurnālists to pārstāsta, tā ir parasta ekstrakcija — avots ir viņa paša runas akts, tikai nodots trešajā personā (#703851 klase). Šķirošanas jautājums ir viens: **vai amatpersona pati kaut kur runāja?** Ja vienīgais avots izteikumam ir biroja darbinieks, atbilde ir nē.

`speaker_id` šeit **nav** risinājums: commentary ceļš ir deprecated kopš 2026-04-25 (Step 3b), un biroja darbinieka sēšana kā atsevišķas entītijas ir operatora lēmums, ne ekstrakcijas solis — kandidāts tikai tad, ja paterns kļūst regulārs (`BACKLOG.md` § Ne-darīt).

**Simulācijas spēle nav nostāja (operatora lēmums 2026-09-15).** Ja politiķis runā izdomāta scenārija ietvaros — LTV priekšvēlēšanu simulācijas spēle «X stunda» (izdomāta pilsēta Silgale, izdomāts incidents; doc 107791, 1. no 3 sērijām), debašu lomu spēle, hipotētisks «ko jūs darītu, ja…» ar izdomātiem faktiem —, teiktais ir spēles gājiens komandas vārdā, ne apgalvojums par reālu politiku, un to **nedrīkst** glabāt kā `position`: pretrunu meklētājs to salīdzinātu ar reālām nostājām, un profils rādītu «uzskata, ka…» par notikumu, kas nav noticis. **Noklusējums: `empty_doc_ids`** ar iemeslu reasoning («simulācijas spēle»). Šķirošanas tests ir tas pats, kas biroja balsij: **vai persona runāja par reālu jautājumu savā vārdā?** Ja spēles ietvaros izskan vispārējs princips, kas nav piesiets izdomātajam scenārijam («esošais regulējums ir adekvāts» par Krievijas karogu), tas TOMĒR paliek spēles kontekstā — glabā tikai tad, ja tā pati nostāja ±5 dienu logā ir izteikta ārpus spēles, un tad TO avotu. Reference: #710876–#710878 (Šnore) glabāti NEEDS_REVIEW 09-14 un dzēsti 09-15 ar šo lēmumu; tā paša dokumenta pārējie 7 `mentioned` politiķi apzināti neekstraktēti.
...
`get_existing_claims(pid, stated_around=<raksta datums>)` (logs pēc `stated_at`
±5 d, ne pēc `created_at` — kopš 2026-09-24) un salīdzini pēc satura: tas pats izteikums
...
Drošības tīkls pēc glabāšanas: `save_analysis()` atgriež `failures` ierakstu
`possible_duplicate` (`claim_id`, `similar_claim_id`, `distance`), ja jaunais
claim vektoriski gandrīz sakrīt ar tā paša politiķa `position` claim ±5 d logā.
Claim jau ir glabāts — izlasi abus un atskaitē nosauc: dublikāts (dzēšanu
ierosini operatoram ar rollback) vai atšķirīga nostāja (atstāj abus).

**`stated_at` ir notikuma LATVIJAS kalendārā diena (konvencija 2026-08-25).**
`documents.published_at` tvītiem nāk UTC, tāpēc pēc 21:00 UTC (vasarā; ziemā
pēc 22:00) LV datums jau ir NĀKAMĀ diena. Pārvērt pirms glabāšanas:
`2026-08-23T21:44 UTC` → `stated_at='2026-08-24'` (doc 93631). Iemesls: viss
pārējais rutīnā ir LV diena — pārskata subjekta datums, `now_lv()` zīmogi,
dienas logi —, tāpēc UTC datums izsviež claim no tā pārskata, kuram tas pieder.
Mērījums 2026-08-24: no 13 pēdējiem vēlā vakara tvītiem 9 nesa UTC dienu, 4 bija
pārbīdīti uz LV — korpuss bija šķelts, jo konvencija nebija pierakstīta.
**Vēsturiskās rindas NELABO** — retroaktīvs bīdījums skartu jau publicētus
pārskatus; noteikums attiecas uz jaunām rindām.

**Ja izteikuma faktiskā diena ir ārpus 7 dienu pārskata loga, `stated_at` =
publiskošanas diena (konvencija 2026-09-07).** Dienas pārskata skelets ievāc
claim vai nu pēc `stated_at` = pārskata diena, vai pēc tajā dienā glabātas
rindas, kuras `stated_at` nav vecāks par septiņām dienām
(`src/briefs.py::_BRIEF_DAY_CLAIM_SQL` grīda). Tāpēc dokumentam, kas šodien
publisko senāku izteikumu (vēstule, atbilde uz deputāta jautājumu, arhīva
runa), raksti `stated_at` = publiskošanas diena, bet **izteikuma īsto datumu
pasaki `stance` tekstā** («30. jūlijā datētā vēstulē …» — tieši tā, kā to dara
#704179), lai datums nepazūd. Precedents: Dombrovska vēstule datēta 30.07., publiskota
27.08. — ar `stated_at='2026-07-30'` tā nebūtu iekritusi nevienā pārskatā
(ceturtā šīs klases instance; iepriekšējās #703962, #703963, #703974). Ja
izteikuma diena ir 7 dienu logā, nekas nemainās — raksti faktisko dienu.
Vēsturiskās rindas arī šeit NEbīda.

**Dienasgrāmatas ieraksti («Diena Nr. N premjera krēslā», Kulbergs) — datums no
iekavām, ne no numura un ne no publicēšanas (operatora lēmums 2026-09-25).**
Kopš augusta ieraksti tiek publicēti ar 3–7 dienu nokavēšanos (Nr. 79 par
18.09. publicēts 24.09.), bet visas 163 līdzšinējās pozīcijas nesa publicēšanas
dienu. Ja ierakstā ir datums iekavās («(PIEKTDIENA 18.Sept)»), `stated_at` =
šī diena, kad tā ir 7 dienu logā; ārpus loga — publicēšanas diena + datums
`stance` tekstā (augstāk). Numuru datuma aprēķinam NEIZMANTO — tas nav
uzticams (Nr. 29, 39, 74 atkārtojas, Nr. 70 nāk pēc Nr. 74). Ja datuma iekavās
nav, raksti publicēšanas dienu un `stance` sāc ar «Dienasgrāmatas ierakstā
Nr. N …», lai lasītājs redz, ka tas ir atskats. Vēsturiskās rindas NEbīda.
...
2. **Latvian text through `python -c`.** Passing `stance`/`reasoning`/`brief`
   ...
   **"Unique" has to mean unique — put your pid(s) in the filename.** On
   2026-08-24 three agents in one fan-out independently chose `ext_0824_*.py`
   and overwrote each other mid-run; nothing was lost only because their writes
   had already completed. The date and the task are the SAME for every agent in
   a wave, so a name built from those collides by construction. Use
   `ext_<pid>_<pid>_0824.py`, not `ext_0824_save.py`.

   **And never name a scratchpad script after a package** — `h11.py`, `h2.py`,
   `httpx.py`, `json.py`. The scratchpad is `sys.path[0]` when you run a script
   from it, so the file shadows the real package that `httpx` / `google-genai`
   pull in. On 2026-08-23 a stray `h11.py` broke `save_analysis()` for one
   agent, and `h2.py` turned up the next day.
...
**Griesti, kas nav vērtējuma jautājums (2026-09-22, precizēts 2026-09-23):** `quote=null` → **ne vairāk par 0.65**, un 0.65 drīkst TIKAI **skaidrs atstāsts** (definīcija Critical Rules § 8); jebkura šaubu pazīme → ≤ 0.6 + `NEEDS_REVIEW:`. Svinīga/ceremoniāla ierāmējuma runa → 0.6 klase pat ar verbatim citātu. Skaitlis apraksta, cik pārbaudāms ir pierādījums, ne cik pārliecināts tu jūties.
...
7. **Documents with no extractable claims** — pass their ids in `empty_doc_ids=[...]` to `save_analysis()` so routine knows they were reviewed; `save_analysis(claims=[])` without `empty_doc_ids` stamps nothing and the document re-enters the queue forever (T5)
8. **Quote the politician when possible** — direct quotes with source URLs are the gold standard
   ...
   **Divi cietie vārti šai klasei (pievienoti 2026-09-22 pēc modeļu mērījumiem — abi tika pārkāpti ar pareizu saturu):**
   - **`quote=null` → `confidence` ≤ 0.65, bez izņēmuma; 0.65 tikai skaidram atstāstam.** Ja citāta nav, tu apraksti tekstu, ko neviens nevar pārbaudīt pret runātāja vārdiem; 0.7–0.75 tur izskatās pēc pārbaudīta fakta. Mērīts v2 kopā: 4 no 7 modeļiem šo pārsniedza tieši trešās personas pārstāsta gadījumā (0.65/0.7/0.75), saturu uzrakstot pareizi.
     **Skaidrs atstāsts (0.65, BEZ `NEEDS_REVIEW`)** — VISI četri: (1) redakcionāls medijs vai oficiāls avots (ne anonīms konts, ne RT); (2) runātājs nosaukts vārdā un atstāsts piesaistīts viņam ar atsauces verbu («norādīja», «uzsvēra», «atzina», «pēc viņa teiktā»); (3) teksts pilns, ne nogriezts/paywall; (4) nostāja izriet no atstāsta tieši — bez tava secinājuma, kam viņš piekrīt, ko domā vai uz ko atbild.
     **Šaubu pazīmes (≤ 0.6 + `NEEDS_REVIEW:` ar pazīmes nosaukumu)** — pietiek ar vienu: nav skaidrs, kurš runā (runātāju bloki jaucas, ministrija/preses dienests bez vārda); atbilde vai reakcija bez redzama konteksta; ironija, sarkasms vai jautājuma forma; ļoti īss teksts (tvīta teaseris, video anonss); nogriezts avots; RT ar trešās puses citātu; jebkas, kur tu pats nebūtu gatavs to parakstīt kā viņa nostāju. **Iemesls 2026-09-23:** ar agrāko «≤ 0.6 bez izņēmuma» katrs atstāsts automātiski saņēma karodziņu (CLAUDE.md eskalācija 2) — 22.–23.09. 40 % un 37 % pozīciju, un karodziņš vairs nenošķīra šaubīgo no parastā (operatora lēmums 2026-09-23).
   - **Nogriezts vai paywall avots → reasoning SĀKAS ar `NEEDS_REVIEW:`.** Zemāka confidence viena pati nepietiek: triāžas rinda filtrē pēc `claims.review_status`, ne pēc skaitļa, tāpēc bez marķiera claim nekad nenonāk cilvēka acu priekšā. Mērīts 09-10: divas paywall/stub ekstrakcijas ar pilnīgi pareizu saturu apietu `@quality-reviewer` tieši tāpēc, ka marķiera nebija. Pazīmes: «Lai turpinātu lasīt», «Pilno rakstu lasiet», teksts beidzas teikuma vidū, `word_count` zem ~120 pie raksta žanra.
...
9. **Pirms katras atbildes — 6 jautājumi** (pievienots 2026-08-12 pēc A/B prompta eksperimenta uz 11 vēsturiskiem misextract precedentiem: kontrolsaraksta variants laboja tieši quote-fidelity robežgadījumus, kur garā prompta noteikumi paliek pasīvi). Izej tos katram dokumentam tieši pirms lēmuma save/empty:
   ...
   4. **Quote = verbatim NEPĀRTRAUKTS pirmās personas teksts?** Ne virsraksts, ne parafrāze, ne sašūti fragmenti — citādi `quote=null` un attiecīgi zemāka confidence. **Divi mehāniski testi (pievienoti 2026-09-22): (a) vai citāts SĀKAS teikuma sākumā?** Ja pirmais burts ir mazais vai citāts sākas ar «ka», «bet», «izdabājot» — tas ir izgriezts no teikuma vidus, #20850 aizliegtā klase; paplašini līdz teikuma sākumam vai liec `quote=null`. **(b) Vai noslēguma pieturzīme ir tieši tā, kas avotā?** Avota `,` vai `!` nedrīkst claimā kļūt par `.` — tas ir termināļa pieturzīmju klase (verdikti 10/50). Mērīts: fragmentāro citātu 08-12 pieļāva A variants, 09-10 SWE-2 un 09-16 Union Alpha — tas ir visizturīgākais formas defekts šajā kopā.
