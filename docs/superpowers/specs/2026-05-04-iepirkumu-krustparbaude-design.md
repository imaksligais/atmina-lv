...
```
PYTHONIOENCODING=utf-8 .venv/Scripts/python.exe scripts/ingest_iub_contracts.py
...
```
PYTHONIOENCODING=utf-8 .venv/Scripts/python.exe scripts/compute_iub_links.py
