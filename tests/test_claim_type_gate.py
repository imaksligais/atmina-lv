...
# `src/wiki.py` sadalīts 2026-09-05 (plāna 5.9): pozīciju vaicājumi tagad dzīvo
# arī `wiki_pages.py` un `wiki_index.py`. Vārti skaita FAILUS, tāpēc moduļa
# sadalīšana bez šīm rindām būtu klusi izņēmusi tos no tvēruma — tieši tas
# defekta veids, ko `test_allowlist_has_no_dead_rows` zemāk sargā no otras puses.
TARGET_FILES = sorted(
