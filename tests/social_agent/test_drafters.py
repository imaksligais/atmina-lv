...
def test_draft_highlight_attack_kind_removed():
    # 'attack' zars (oppo_briefs mantojums) izgriezts 2026-07-29 — nezināms kind krīt skaļi.
    with pytest.raises(ValueError):
        draft_highlight({"kind": "attack", "text": "x"})
