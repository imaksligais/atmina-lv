...
def test_www_prefix_removal_does_not_eat_leading_w():
    """`"www.wp.lv".lstrip("www.")` → "p.lv" (the bug); removeprefix keeps "wp.lv".
    The section filter must therefore treat www.wp.lv like wp.lv, not like p.lv."""
    from urllib.parse import urlparse
    assert urlparse("https://www.wp.lv/a").netloc.removeprefix("www.") == "wp.lv"
    assert _irs("https://www.wp.lv/politika/a") == _irs("https://wp.lv/politika/a")
