...
from src.generate import _fetch_personas, _fetch_personas_metrics, _persona_category, _persona_sort_name
...
class TestPersonaSortName:
    ...
    def test_person_flipped_to_surname_first(self):
        ...
        assert _persona_sort_name("Evika Siliņa", "Amatpersonas") == "Siliņa Evika"
