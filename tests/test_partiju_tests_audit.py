...
def test_repo_audit_known_state():
    ...
    (≥6/≥2) un 10 no 12 FAIL § 3.3 vārtam (≥8/≥3) — kopš 2026-09-17 3. līmeņa
    5 šūnām q05 iziet (bija 11 no 12). Ja 0 — skripts salūzis."""
    _repo_files_or_skip()
    ...
    assert len(old) == 12 and n_old == 9 and n_new == 10
