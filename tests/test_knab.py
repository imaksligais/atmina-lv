...
def test_parse_donations_page():
    ...
    with open(fixture_path, "r", encoding="utf-8") as f:
        html = f.read()
    from src.knab.parse import parse_donations_page
...
def test_parse_amount():
    ...
    from src.knab.parse import _parse_amount
...
def test_parse_date_lv():
    ...
    from src.knab.parse import _parse_date_lv
...
def test_extract_donor_pid():
    ...
    from src.knab.parse import _extract_donor_pid
...
def test_parse_declarations_page():
    ...
    with open(fixture_path, "r", encoding="utf-8") as f:
        html = f.read()
    from src.knab.parse import parse_declarations_page
...
def test_build_url():
    from src.knab.ingest import _build_url
    from src.knab.parse import DONATIONS_URL
...
def test_get_total_pages_from_fixture():
    ...
    with open(fixture_path, "r", encoding="utf-8") as f:
        html = f.read()
    from src.knab.ingest import _get_total_pages
...
def test_upsert_donor_creates_and_deduplicates(tmp_path):
    ...
    init_db(db_path)
    db = get_db(db_path)
    from src.knab.ingest import _upsert_donor
...
def test_store_donations_deduplicates(tmp_path):
    ...
    init_db(db_path)
    db = get_db(db_path)
    from src.knab.ingest import _store_donations
    donations = [{
        "knab_id": "test-001",
        "party": "Test Party",
        "donation_type": "Nauda",
...
def test_is_tracked_party_matches():
    from src.knab.ingest import _is_tracked_party
...
def test_store_declarations_deduplicates(tmp_path):
    ...
    init_db(db_path)
    db = get_db(db_path)
    from src.knab.ingest import _store_declarations
    decls = [{
...
def test_normalize_name():
    from src.knab.analyze import _normalize_name
...
def test_detect_multi_party_donors(tmp_path):
    ...
    from src.knab.analyze import detect_multi_party_donors
...
def test_detect_family_clusters(tmp_path):
    ...
    from src.knab.analyze import detect_family_clusters
...
def test_get_party_summary(tmp_path):
    ...
    db = get_db(db_path)
    from src.knab.ingest import _store_donations
    from src.knab.queries import get_party_summary
    donations = [
...
def test_live_fetch_one_page(tmp_path):
    ...
    from src.knab.ingest import fetch_all_donations
...
def test_parse_euro():
    ...
    from src.knab.parse import _parse_euro
...
def test_parse_declaration_detail():
    ...
    with open(fixture_path, "r", encoding="utf-8") as f:
        html = f.read()
    from src.knab.parse import parse_declaration_detail
...
def test_payment_to_donation_eur():
    ...
    from src.knab.ingest import _payment_to_donation
    pay = {
...
def test_get_top_donors_nets_positive_and_refund(tmp_path):
    ...
    db = get_db(db_path)
    from src.knab.ingest import _store_donations
    from src.knab.queries import get_top_donors
...
def test_fetch_all_donations_marks_truncated_batch_incomplete(tmp_path, monkeypatch):
    ...
    init_db(db_path)
    from src.knab import ingest as knab
...
def test_declaration_detail_rows_field_map():
    ...
    """
    from src.knab.parse import _declaration_detail_from_rows
    rows = [
...
def test_live_fetch_one_declaration_page(tmp_path):
    ...
    from src.db import init_db, get_db
    init_db(db_path)
    from src.knab.ingest import fetch_all_declarations
