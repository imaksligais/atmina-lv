...
EXPECTED_TABLES = {
    ...
    "parties",
    "brief_images",
    # image_audit — viens saucējs attēlu mēneša budžetam (verdikts 47b,
    # 2026-09-07); rakstīts generate_image() līmenī, tāpēc sedz arī `cli thread`
    # un tiešos izsaukumus, ko `brief_images` nekad neredzēja.
    "image_audit",
    ...
    "external_profiles",
    "publish_approvals",
    # TypeSafe Saites priekšlikumi (src/db_migrations.py, 2026-09-18)
    "tension_proposals",
    "tension_judged",
    # vec0 virtual tables
    "document_vectors",
