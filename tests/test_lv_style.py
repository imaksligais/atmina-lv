...
def test_surname_rule_fires_without_db(tmp_path):
    ...
    # tmp_path, ne data/: vecais ceļš katrā palaidienā atstāja 0 baitu failu
    # data/__nav_tadas_db__.db (iztīrīts 2026-09-24).
    dbmod.DB_PATH = str(tmp_path / "__nav_tadas_db__.db")
    try:
